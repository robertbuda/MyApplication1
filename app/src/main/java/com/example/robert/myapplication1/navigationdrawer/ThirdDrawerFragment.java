...
public class ThirdDrawerFragment extends android.support.v4.app.Fragment implements TextCommunicator {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_drawer_third,container,false);
